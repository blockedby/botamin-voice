...
export const REACTION_CLIP_GENERATION_CORPUS = [
	...
	{ id: "schedule-calculating-options", text: "Рассчитываю варианты." },
	{ id: "schedule-checking-intervals", text: "Проверяю интервалы." },
	{ id: "schedule-matching-time", text: "Сверяю доступное время." },
	{ id: "validation-checking-data", text: "Проверяю данные." },
	{ id: "validation-checking-format", text: "Сверяю формат." },
	{ id: "validation-checking-fields", text: "Проверяю поля." },
	{ id: "objection-examine", text: "Давайте разберём." },
	{ id: "objection-more-detail", text: "Рассмотрим подробнее." },
	{ id: "objection-to-the-point", text: "Перейдём к сути." },
	{ id: "clarification-one-point", text: "Уточню один момент." },
	{ id: "clarification-one-detail", text: "Нужна одна деталь." },
	{ id: "clarification-meaning", text: "Уточним смысл." },

...
| REV-003 | Runtime constructs a validated non-PII console acknowledgment or signed bounded-webhook notifier, starts a persisted retry worker, reports worker readiness, and drains/aborts delivery on shutdown. Covered by notifier/outbox and runtime readiness tests. |

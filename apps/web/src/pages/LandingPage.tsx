			...
			<main className="landing-page" id="top">
				...
				<section className="trust-section" aria-labelledby="trust-title">
					...
					<ul>
						...
						<li>
							<strong>Без внешнего календаря.</strong>
							<span>
								После явного подтверждения создаётся внутренняя виртуальная
								встреча Botamin, но внешнее календарное событие и приглашение не
								создаются.
							</span>
						</li>
					</ul>

...
- **FR-VOICE-018:** 16 committed same-origin reaction MP3s require negotiated allowlist capability and may play once per eligible turn after 350 ms. They make zero runtime provider calls and cannot affect transcript, state, booking, tools, or provider behavior.
